  ...
  if (isLoading) {
    return (
      <div className="container mx-auto px-4 py-32 flex flex-col items-center justify-center">
        ...
        <p className="text-luxury-gray font-outfit uppercase tracking-widest text-xs">Arrivées en cours...</p>
      </div>
    );
  }
    ...
    <div className="bg-luxury-offwhite min-h-screen pb-24">
      <div className="bg-white border-b border-black/5 pt-32 pb-16">
        <div className="container mx-auto px-6 text-center">
          <span className="text-[10px] font-bold tracking-[0.2em] text-luxury-gray uppercase">Avant-Première</span>
          ...
          <p className="text-luxury-gray max-w-lg mx-auto text-sm font-light">
            Découvrez le summum de la technologie mobile. Les modèles les plus récents, authentiques et garantis sous blister.
          </p>
        </div>
      </div>
      ...
      <div className="container mx-auto px-6 py-16">
        {products.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 text-center border-2 border-dashed border-black/5 rounded-3xl bg-white">
            ...
            <h3 className="text-lg font-outfit font-light text-luxury-charcoal mb-2">Collection à venir</h3>
            <p className="text-sm text-luxury-gray max-w-xs">
              Nous préparons l'arrivée des derniers fleurons technologiques. Restez connectés.
            </p>
          </div>
        )}
      </div>
